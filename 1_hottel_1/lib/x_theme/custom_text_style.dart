...
class CustomTextStyles {
  ...
  static get bodyLargeSecondaryContainer => basicTheme().textTheme.bodyLarge!.copyWith(
  ...
  // Title text style
  static get titleMediumAmberA700 => basicTheme().textTheme.titleMedium!.copyWith(
  ...
  static get titleMediumPrimary_1 => basicTheme().textTheme.titleMedium!.copyWith(
        color: basicTheme().colorScheme.primary,
      );
  ...
  static get titleMediumWhiteA700 => basicTheme().textTheme.titleMedium!.copyWith(
